...
expr_dir_gaus  = root+'visualization/data/dich_expr_gaus95'
fig_dir = root+'visualization/data/result_dich_expr_gaus95'
...
for group_name, group_data in grouped_df:
    ...
    for idx, row in group_data.iterrows():
        ...
        for index, marker in enumerate(c_expr_df.columns):
            ...
            dichotomized_values = (raw_values > intersection_point).astype(int)
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(fig_dir, fname.split('.')[0]+'.png'))
...
plt.tight_layout()
plt.savefig(os.path.join(fig_dir, 'Dich_expr_gaus.png'))
