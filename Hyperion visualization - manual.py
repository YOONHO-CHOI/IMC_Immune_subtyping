...
p_ids   = ['REQ31365_OTL7_Tumor','REQ30820_20210503_0NVB','REQ30820_20210503_0NVD',
           'REQ30820_20210503_0NVF','REQ31365_OTL9_TUMOR']
...
save_dir = '/home/ext_choi_yoonho_mayo_edu/jupyter/Project/IMC/visualization/results_manual_v1'
os.makedirs(save_dir, exist_ok=True)
# marker_x=['170Er-CD3_dichotomized', '143Nd-Vimentin_dichotomized', '141-SMA_dichotomized',
#           '148-Pan-Ker_dichotomized', '155Gd-FoxP3_dichotomized']
...
for p_id,sub in zip(p_ids,sub_type):
    ...
    for i, ROI in enumerate(ROI_p):
        ...
        targets = ['CD3', 'Stroma', 'CD3+FoxP3', 'PanCK']
        dict = {'CD3':(1,0,0), 'Stroma':(0,1,0), 'PanCK':(0,0,1), 'CD3+FoxP3':(1,1,1), 'None':(0,0,0)}
        non_targets = [i for i in np.unique(new).tolist() if i not in targets]
        for non_target in non_targets:
            new = new.replace(non_target, 'None')
        df.new = new
